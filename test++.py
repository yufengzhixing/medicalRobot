...
train_encode_vocabulary = '/home/di/pycharmProjects/medicalRobot_3/data/train_encode_vocabulary'
train_decode_vocabulary = '/home/di/pycharmProjects/medicalRobot_3/data/train_decode_vocabulary'
...
with tf.Session() as sess:
    ...
    while True:
        input_string = raw_input('病人： > ')
        # 退出
        if input_string == 'exit':
            exit()
        input_string_vec = []
        for words in jieba.cut(input_string.strip()):
            input_string_vec.append(vocab_en.get(words, UNK_ID))
        # print len(input_string_vec),type(input_string_vec)
