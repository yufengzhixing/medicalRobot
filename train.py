...
train_encode_vec = '/home/di/pycharmProjects/medicalRobot_3/data/train_encode.vec'
train_decode_vec = '/home/di/pycharmProjects/medicalRobot_3/data/train_decode.vec'
test_encode_vec = '/home/di/pycharmProjects/medicalRobot_3/data/test_encode.vec'
test_decode_vec = '/home/di/pycharmProjects/medicalRobot_3/data/test_decode.vec'

# 词汇表大小5000
vocabulary_encode_size = 15267
vocabulary_decode_size = 15267

buckets = [(5, 10), (10, 15), (20, 25), (40, 50)]#填充句子大小
layer_size = 256  # 每层大小
num_layers = 3  # 层数
batch_size = 64
...
# 恢复前一次训练
    ...
    while True:
        ...
        if total_step % 500 == 0:
            ...
            # 保存模型
            checkpoint_path = "/home/di/pycharmProjects/medicalRobot_3/data/chatbot_seq2seq.ckpt"
